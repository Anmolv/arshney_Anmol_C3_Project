...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        Restaurant restaurantMocked = Mockito.spy(restaurant);
        Mockito.when(restaurantMocked.getCurrentTime()).thenReturn(LocalTime.parse("11:30:00"));
        assertTrue(restaurantMocked.isRestaurantOpen());
    }

    @Test
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant restaurantMocked = Mockito.spy(restaurant);
        Mockito.when(restaurantMocked.getCurrentTime()).thenReturn(LocalTime.parse("09:30:00"));
        assertFalse(restaurantMocked.isRestaurantOpen());
    }
